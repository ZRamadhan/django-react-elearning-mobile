...
class ProsesTersangka extends React.PureComponent {
  render() {
    ...
    return (
        ...
        style={{
          ...
          <TouchableOpacity onPress={() => this.props.navigation.navigate('prosesTSK.details', {
          	id: item.id
          })}>
            <View style={{margin:5}}>
              <Text 
             ...
             <View style={{position:'absolute', right:5, top:5}}>
                <Menu>
                  ...
                  <MenuOptions style={{backgroundColor: '#F5FCFF'}}>
                    <MenuOption onSelect={() => this.props.navigation.navigate('prosesTSK.edit', {
                      id: item.id
                    })}>
...
export default withNavigation(ProsesTersangka);
