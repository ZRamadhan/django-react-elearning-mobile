...
class StatusTersangkaList extends React.Component {
  state = {
    loading: false,
  }
    ...
    const buttonGroup = (
      <React.Fragment>
        <Button
          ...
          onPress={()=>this.props.navigation.navigate('statusTSK.new')}
        />
      </React.Fragment>
    )
    ...
    return (
      <NavigationBar hideSearch renderButton={buttonGroup} loading={this.state.loading}>
        <SafeAreaView style={styles.container}>
          <Text>Ini Status Tersangka List</Text>
        </SafeAreaView>
      </NavigationBar>
    )
  }
...
export default connect(mapStateToProps)(StatusTersangkaList)
